<template>
    <div class="gallery">
        ...
        <div v-for="(photo, index) in photos" :key="index" class="gallery-item" @click="openModal(index)">
            <img :src="photo" alt="Photo" loading="lazy" />
        </div>
        <div v-if="showModal" class="modal" @click.self="closeModal" @touchstart="startSwipe" @touchmove="onSwipeMove"
            @touchend="endSwipe">
