<template>
  <div class="drone-view">
    <span v-if="isMobile" class="drone-view__label">CATEGORY: DRONE</span>
    <div v-for="(video, index) in videos" :key="index" class="drone-view__videos" @click="openVideo(video.videoUrl)">
      <img class="drone-view__videos-image" :src="video.thumbnail" alt="Video" />
      <div class="flex flex-col drone-view__videos-text">
